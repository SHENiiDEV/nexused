        ...
        <AppLayout title="Corporate B2B Portal">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
                ...
                <div className="border-b border-slate-800 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-950/80 border border-teal-800/60 text-teal-400 text-xs font-mono font-semibold uppercase mb-2">
                            <Building2 className="w-3.5 h-3.5" /> B2B Corporate Hub
                        </div>
                        <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
                            {company.name}
                        </h1>
                        <p className="mt-1 text-slate-400 text-sm">
                            VAT: <span className="font-mono text-slate-300">{company.vat_number || 'DE389201940'}</span> • European Invoicing Standard: Peppol BIS 3.0 / UBL 2.1
                        </p>
                    </div>

                    <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-right">
                        <div className="text-xs text-slate-400">Licensed Seats</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
                        ...
                        <div className="text-2xl font-black text-white font-mono">{seatUsagePercent}%</div>
                        <div className="w-full bg-slate-800 rounded-full h-1.5 overflow-hidden">
                            <div className="bg-emerald-500 h-full rounded-full" style={{ width: `${seatUsagePercent}%` }} />
                        </div>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
                        ...
                        <div className="text-2xl font-black text-white font-mono">{employees.length}</div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="rounded-2xl border border-slate-800 bg-slate-900 overflow-hidden shadow-xl">
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-xs">
                                    <thead className="border-b border-slate-800 bg-slate-950/60 font-semibold text-slate-300">
                                        <tr>
                    ...
                    <div className="lg:col-span-4 p-6 rounded-2xl bg-slate-900 border border-slate-800 shadow-xl space-y-5">
                        <div className="flex items-center gap-2">
                            <Plus className="w-5 h-5 text-emerald-400" />
                            <h3 className="text-base font-bold text-white">Allocate Seat & Invite</h3>
                        </div>
                        ...
                        <form onSubmit={handleInvite} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                />
                            </div>
                            ...
                            <button
                                ...
                                className="w-full py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white font-bold text-xs transition-all shadow-md shadow-emerald-950 disabled:opacity-50 flex items-center justify-center gap-1.5"
                            >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                        <div>
                            ...
                            <p className="text-xs text-slate-400 mt-0.5">
                                Download printable PDF invoices or export structured UBL 2.1 XML files compliant with EU e-invoicing directives.
                            </p>
                        </div>
                    </div>
                                        ...
                                        invoices.map((inv) => (
                                            <tr key={inv.id} className="hover:bg-slate-800/40 transition-colors">
                                                ...
                                                <td className="p-4 text-right space-x-2 whitespace-nowrap">
                                                    ...
                                                    {/* Export Peppol UBL 2.1 XML */}
                                                    <a
                                                        href={`/corporate/invoices/${inv.id}/ubl`}
                                                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-950 hover:bg-emerald-900 border border-emerald-800 text-emerald-300 text-xs font-semibold transition-colors"
                                                    >
