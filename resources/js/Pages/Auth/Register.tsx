            ...
            <div className="max-w-md mx-auto px-4 py-12">
                <div className="rounded-3xl bg-slate-900 border border-slate-800 p-8 shadow-2xl space-y-6">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-xs text-slate-400">Join the next-generation AI learning platform</p>
                    </div>
                        ...
                        {data.role === 'corporate' && (
                            <>
                                <div>
                                    ...
                                    />
                                    {errors.company_name && (
                                        <div className="text-rose-400 text-xs mt-1">{errors.company_name}</div>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 font-mono"
                                    />
                                </div>
                            </>
                        )}
